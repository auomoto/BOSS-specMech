/*------------------------------------------------------------------------------
oled.c
	Driving Newhaven NHD-0216AW-1B3 OLED display:
	(https://drive.google.com/file/d/1IUcGcaOP8XE-vmXZrItMla3q6HhXh7-s/view)
	This is a small 2-line 16-character blue OLED display with a TWI (I2C)
	interface.
	...
	respectively. Display 0 is on the right, display 1 is on the left.
------------------------------------------------------------------------------*/
