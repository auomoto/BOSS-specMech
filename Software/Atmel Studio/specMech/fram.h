...
#define ENCAFRAMADDR	(20)	// Motor A encoder value (4 bytes)
#define ENCBFRAMADDR	(24)	// Motor B encoder value (4 bytes)
#define ENCCFRAMADDR	(28)	// Motor C encoder value (4 bytes)
